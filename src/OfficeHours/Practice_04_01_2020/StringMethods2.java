...
public class StringMethods2 {
    public static void main(String[] args) {
        ...
        // equalsIgnoreCase(): checks if the two string of texts are equals or not(without case sensitivity), returns boolean
        // ==
        String s1 = "cat";
        ...
        // contains(str): checks if str is included in the string, returns boolean
        ...
        // startsWith(str): checks if the string is started with the given str
