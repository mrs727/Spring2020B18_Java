...
public class StringMethods {
    ...
    public static void main(String[] args) {
        ...
        // trim(): removes unused(white) spaces from the string. as long as they are not separating two characters
        ...
        // substring(beginningIndex, endingIndex): starts to create substring starting from beginning index till ending index(ending index excluded)
        ...
        // substring(beginningIndex): creates substring from beginning index till the end of the string; returns new string
        ...
        System.out.println(t1); // "C# is fun, Java is good"
        ...
        //lastIndexOf(str): returns the index of last matching charcater, as an int
